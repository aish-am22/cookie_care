-- Manual one-shot reset for local/dev databases.
-- Run with: npx prisma db execute --file scripts/reset-documentchunk-embedding.sql --schema prisma/schema.prisma
